...
config.SCHEMA = {
    ...
    { key = "calNorthYaw",   group = "cal",    kind = "number", def = 180,  min = -180, max = 180, step = 5,
      help = "The yaw north sits at, which in Minecraft is 180. The whole compass rose the align stage walks is placed off this, so a dimension whose north is elsewhere is said here rather than guessed from a magnetic reading.",
      symptom = "the rose sends the ship to the wrong point of the compass at every point, by the same amount" },
