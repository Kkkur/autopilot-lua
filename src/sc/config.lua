...
config.SCHEMA = {
    ...
    { key = "yawApproachMin", group = "tank",  kind = "number", def = 1.5,  min = 0.1, max = 20, step = 0.1,
      help = "Slowest turn the approach will ask for, deg/s. Without a floor the last fraction of a degree asks for nothing and the demand falls under tankRpmMin.",
      symptom = "the turn stops a degree short and sits there" },
